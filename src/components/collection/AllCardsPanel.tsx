...
import { CARDS, BONUS_CARDS, TEAMS, CARD_TYPES, Card, BonusCard } from '@/data/cards';
...
export default function AllCardsPanel({ collection, pendingCardIds, onCardClick }: Props) {
